...
@NamedQueries({
    ...
    @NamedQuery(name="Image.findAllShared",
                query="SELECT p FROM Image p Join p.album a join a.sharedWith s WHERE s.id=:currentUser"),
    @NamedQuery(name="Picture.findAllFromOneAlbum",
                query="SELECT p FROM Image p WHERE p.album=:album"),
})
public class Image implements Serializable {
    ...
    public void setFile(byte[] file) throws DaoException {
